...
describe("Faculty Loads Service", () => {
  describe("loadHoursRegEx", () => {
    ...
    const testCases = [
      ...
      {
        in: "CS-104-A (1), CS-104-B (1), CS-104-C (1), CS-104L-A (1), CS-104L-B (1), CS-104L-C (1), CS-104L-D (1), CS-195-A (0.5), CS-295-A (0.5), CS-396-A (0.25)",
        out: "CS-104-A, CS-104-B, CS-104-C, CS-104L-A, CS-104L-B, CS-104L-C, CS-104L-D, CS-195-A, CS-295-A, CS-396-A",
      },
    ...
    testCases.forEach((testCase) => {
      test(`should parse out faculty hour specs from "${testCase.in}"`, () => {
        expect(testCase.in.split(loadHoursRegEx).join("")).toBe(testCase.out);
      });
    });
  });
});
